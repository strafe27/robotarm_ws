...
def determine_color(contour, frame):
    ...
    while not rospy.is_shutdown():
        ...
        for contour in contours:
            if 1000 < cv2.contourArea(contour) < 35000:
                ...
                z = determine_color(contour, frame)

                # Append coordinates and color code to the array
                coordinates_array.append(P0[0][0]*0.001025)
                coordinates_array.append(P0[1][0]*0.00084)
                coordinates_array.append(z)
